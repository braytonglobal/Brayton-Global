  ...
  request.onload = function () {
    if (request.readyState === request.DONE) {
      if (request.status === 200) {
       ...
       %0D%0A
       %0D%0AKind regards,`
       var button = `<a class="pbtn btn btn-outline-secondary" href="mailto:${emailAddress}?subject=${reference} ${position}&body=${mailBody}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
       ...
       let htmlDisplay = `<table class=' item'>
          <thead>
              ...
              <tbody>
                  ...
                  <tr>
                      <td class='text-center' colspan='2'>${button}</td>
                  </tr>
              </tbody>
      </table>`;
